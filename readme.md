...
## TMD Layer
We also experiment adding TMD Layers to the architecture which improved the performance of classes with lower and medium samples. 

Calling the 
```ResnetEncoder(..fc_tmd_layer= True)```

will initialize tmd layer in the penultimate layer. We show examples of using this in **demo1_first-stage-training.ipynb** and fine tuning the result in
**demo2_second-stage-training.ipynb** <br> 
